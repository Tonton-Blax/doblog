	...
	<div class="items-center lg:flex">
		<div class="w-full lg:w-1/2">
			<div class="lg:max-w-lg">
				<h2 class="text-2xl font-semibold text-gray-800 uppercase dark:text-white lg:text-3xl">{post.contenu[1].h2}</h2>
				<p class="mt-2 text-gray-600 dark:text-gray-400">{@html post.contenu[2].body}</p>
		...
		<div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
			<img class="w-full h-full lg:max-w-2xl" src="{post.thumbnail}" alt="Catalogue-pana.svg">
		</div>
	</div>
</div>